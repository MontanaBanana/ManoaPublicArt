...
pathContent['air'] = {
    ...
    video_url: 		'',
    gallery_images: [
			{ image: 'A1.png', headline: 'Creation of the first man', description: 'Air by Juliette May Fraser is arguably the most complex of the Bilger Hall murals. The central image depicts the creation  of the first man by the Hawaiian god Kane, aided by the gods Lono and Kū.' },
			{ image: 'A2.png', headline: 'Discovering his identity', description: ' According to the story, there was a time when all beings lived in darkness. Kane realized that he was a separate being, apart of this darkness, and so he pulled himself from it. Seeing this, the gods Lono and Kū followed his example.' },
			{ image: 'A3.jpg', headline: 'A symbol of agriculture and peace', description: 'Lono is known as the god of agriculture and peace.' },
			{ image: 'A4.jpg', headline: 'A symbol of war', description: 'Kū is known as the god of war.' },
			{ image: 'A5.jpg', headline: 'The creation of light, sound, and substance', description: 'In separating themselves from the darkness, each god brought a unique element to the world. Kane brought light, Lono brought sound, and Kū brought substance.' },
			{ image: 'A6.jpg', headline: 'Giving shape to the world', description: 'With these elements, they began to shape the world around them, till it came time to shape and give life to the first man.' },
			{ image: 'A7.jpg', headline: 'Molding a clay man', description: 'To do so, they took clay from various corners of the world and carefully molded a figure resembling a man.' },
			{ image: 'A8.png', headline: 'Breathing life into the figure', description: 'Then the gods, guided by Kane, breathed into the figure and gave life to the first man.' },
                    ],
...
pathContent['earth'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'E1.png', headline: 'Breadfruit, the bountiful', description: 'Early Hawaiians enjoyed a variety of nutritional food sources, one of them being ʻulu, or breadfruit. Practitioners know of several stories that tell of how ʻulu was first introduced into the Hawaiian diet.' },
	{ image: 'E2.png', headline: 'Making a sacrifice for family', description: 'The version depicted in Earth by Sueko Kimura tells of the Hawaiian god Kū, who planted himself into the ground to feed his family.' },
	{ image: 'E3.png', headline: 'In the beginning, a marriage', description: 'This story tells of Kū, who marries a beautiful Hawaiian woman with whom he starts a family. ' },
	{ image: 'E4.png', headline: 'Keeping a secret identity', description: 'He decides to keep his identity as a god a secret from his family, and works to provide for them just as any human father would. However, a time comes when a great famine falls over the land and Kū’s wife and children begin to starve.' },
	{ image: 'E5.png', headline: 'The ultimate gift one can give', description: 'Feeling great remorse for his family’s suffering, Kū approaches his wife and tells her that in order to feed their family he must go to a place to which he can never return. She protests, but after hearing the cries of her starving family, she finally agrees to let him go.' },
	{ image: 'E6.png', headline: 'Watered by tears', description: 'Kū then takes her out into the yard where he plants himself headfirst into the ground.  Watered by his wife’s tears, his limbs begin to transform into the limbs of the first breadfruit tree.' },
    ],
    location: 		'Go to UH\'s Bilger Hall',
...
pathContent['fire'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'F1.png', headline: 'The volcano goddess', description: 'Perhaps one of the most notorious of the Hawaiian deities is Pele, the volcano goddess. ' },
	{ image: 'F2.png', headline: 'Telling the story of Lohiau', description: 'Fire, by Richard Lucier, tells of the death of Lohiau, a young chief from Kauaʻi whom Pele had planned to take as her husband. ' },
	{ image: 'F3.jpg', headline: 'Pele falls in love', description: 'This version of the story begins when Pele falls madly in love with Lohiau while touring the islands in search of a new home. ' },
	{ image: 'F4.jpg', headline: 'Seeking the help of her sister', description: 'Upon finally establishing her home at Halemaʻumaʻu on Hawaiʻi Island, Pele sends her dearest sister Hiʻiaka to Kauaʻi to fetch Lohiau. ' },
	{ image: 'F5.jpg', headline: 'What’s taking her so long?', description: 'Hiʻiaka’s journey to Kaua’i and back takes longer than expected, and Pele becomes impatient.' },
	{ image: 'F6.png', headline: 'Revenge time', description: 'As the days pass, Pele begins to believe that Hiʻiaka has betrayed her and kills Hiʻiaka’s beloved friend Hopoe out of anger. Hiʻiaka, who has by now fetched Lohiau and is approaching the crater, sees what Pele has done and decides to take revenge by passionately embracing Lohiau in front of her sister' },
	{ image: 'F7.jpg', headline: 'A fiery grave', description: 'An infuriated Pele calls on her other sisters to help her encircle Lohiau in a whirpool of magma, sending him to his fiery grave. ' },
    ],
    location: 		'Go to UH\'s Bilger Hall',
...
pathContent['water'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'W1.png', headline: 'The story of Kane and Kanaloa', description: 'David Asherman’s Water, tells of the gods Kane and Kanaloa and their search for fresh water.' },
	{ image: 'W2.png', headline: 'Dirty and hungry, looking for water', description: 'After a day of swimming, Kane and Kanaloa emerge from the sea and begin to search for a place to rinse themselves and feed their thirst.' },
	{ image: 'W3.png', headline: 'Searching for water', description: 'The two head westward and look far and wide for a fresh water source, but none can be found. They begin to grow impatient and weary for a lack of drinking water. ' },
	{ image: 'W4.png', headline: 'What’s beneath this land', description: 'Finally, they come to Mānoa, where Kane is certain that he can hear water moving in the ground underneath them.' },
	{ image: 'W5.png', headline: 'A reservoir is discovered', description: 'He strikes the ground with his spear and out bursts a stream of fresh water.' },
	{ image: 'W6.png', headline: 'The origin story of a stream', description: 'Kane and Kanaloa are then able to wash themselves and drink from the stream, which would later become known as Mānoa Stream.' },
    ],
    location: 		'Go to UH\'s Bilger Hall',
...
pathContent['founders_gate'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'FG1.png', headline: 'A gateway to nowhere', description: ' As configured today, Founders Gate seems to lead into the Manoa neighborhood, not the university campus, as originally intended, when it was built in the 1930s.' },
	{ image: 'FG2.png', headline: 'A memorial to UH’s ambitions', description: ' This gate was at first described as a “memorial to the men who fathered the development of the University of Hawai‘i and the Territorial Normal School.” ' },
	{ image: 'FG3.png', headline: 'Students paid for these', description: 'These two cast-stone arches, across the street from each other, underneath monkeypod trees, were paid for by student fees ($1 per student), with the promise that they would serve as the gateway to campus.' },
	{ image: 'FG4.jpg', headline: 'Above all Nations is Humanity', description: 'According to the UH Campus Heritage Report, university president David Crawford dedicated the gates by saying, “let only those who enter here come with hunger to learn and with determination to use aright their learning for the good of mankind.” One gate bench reads, in both Hawaiian and English: “Above all Nations is Humanity.”' },
	{ image: 'FG5.jpg', headline: 'Moved once, but should they be moved again?', description: ' Yet as real estate blossomed around the campus, and University Avenue was widened, the gates had to be moved as well. When they were moved the first time, they simply were pushed out to the new sidewalks. As the monkeypod trees have dwarfed them, and they have lost their original purpose, though, could a more dramatic move benefit both the gates and the campus?' },
...
pathContent['relation_of_man_and_nature'] = {
    ...
    video_url: 		'',
    gallery_images: [
		{ image: 'R1.jpg', headline: 'A name to know, Jean Charlot', description: 'After coming to Hawai’i in 1949, French artist and writer Jean Charlot (1898 -1979) wanted to express his vision of Hawaiian culture.' },
		{ image: 'R2.jpg', headline: 'Intercultural expressions', description: 'Charlot had noticed the lack of monumental and heroic expressions within the ideology of Americanism already taking root within the territory, which would become a state in 1959. While Charlot could not yet read the Hawaiian language, when he created his mural, the theme of this image was clear to him across cultures.' },
...
pathContent['harvest_celebration'] = {
    ...
    video_url: 		'',
    gallery_images: [
		{ image: 'H1.png', headline: 'Originally made for the World’s Fair', description: "This mural was created by Juliette May Fraser for the 1939 San Francisco World's Fair. It consists of 13 masonite panels depicting the harvest and gift-giving ceremony of Native Hawaiians during the Makahiki season. Fraser was born in Honolulu during the reign of King Kalakaua, and built a reputation for portraying Hawaiian legends and other themes through linoleum cut, oil painting, ceramic, and fresco." },
		{ image: 'H2.png', headline: 'Celebrated from October through February', description: 'The Makahiki season is dedicated to honor the god Lono, who is associated with fertility, rainfall, agriculture, food, music and peace. Makahiki is roughly four months long and usually celebrated October through February.' },
		{ image: 'H3.png', headline: 'Warfare was forbidden during this season', description: 'Ancient Hawaiians stopped their work and made offerings to the chief or aliʻi. Warfare was forbidden during Makahiki season. Time then was also spent on practicing sports, eating, dancing and renewing communal bonds.' },
		{ image: 'H4.png', headline: 'Making offerings, like taxes', description: 'Ancient Hawaiians collected agricultural and aquacultural products like pigs, taro, sweet potatoes, dry fish, kapa and mats. Some even offered feathers from forest birds, and all of these hoʻokupu (offering) were presented or collected sort of like taxes (Auhau) during Makahiki.' },
		{ image: 'H5.png', headline: 'Paying tribute to the High Chief', description: 'Each ahupuaʻa gathered its taxes to be given to the Ali’i Nui or the High Chief of the island. He acted as the deputy for Lono during the Makahiki Festival. The Ali’i Nui would hold an Akua Loa (representation of Lono), which was a long pole with a carved pig’s head on top and a strip of tapa (ancient Hawaiian cloth).' },
		{ image: 'H6.png', headline: 'A time for fun', description: 'Ancient Hawaiians were passionate to test their minds with games, which consisted of riddles, recitation of genealogies, proverbs and knowledge of hidden meanings, even board games, which was a stone slab or flat surface with shallow holes.' },
		{ image: 'H7.png', headline: 'Make an offering to UH?', description: 'Just like during the Makahiki season, with Native Hawaiians, set time aside today for peace and relaxation. Try to enjoy some games, test your brain or even dance. Maybe even make an offering, or in this case a donation. If you want to give back to The University of Hawaii, or support a specific part of the UH system, any contribution would be gladly appreciated. <a href="https://giving.uhfoundation.org/give-now" target="_system" style="color: white;">Tap to donate</a>' },
    ],
...
pathContent['maka_io_or_hawks_eye'] = {
    ...
    video_url: 		'',
    gallery_images: [
		{ image: 'M1.jpg', headline: 'Once prominent but no longer', description: "Students, teachers and visitors once were greeted by a curious contraption as they entered the University of Hawaii at Manoa’s lower campus. For nearly a decade, the Maka ‘Io served as a proud symbol of strength and teamwork, representing the university’s flourishing athletic programs." },
		{ image: 'M2.jpg', headline: 'Vision and motion in sculpture', description: 'When Maka Io first was installed at the university in 1984, it was said to encompass the spirit of the Hawaiian hawk’s keen eye and express the motion of sport.' },
		{ image: 'M3.jpg', headline: 'Displaced by arena construction', description: 'Yet in 1994, during the construction of the Stan Sheriff Center, Edward Brownlee’s sculpture was moved from its original location to a seemingly random field in front of Klum Gym.' },
		{ image: 'M4.jpg', headline: 'Where else can Brownlee’s work be found?', description: 'What the heck is it doing here? The sculpture now is cloaked in the shade of various trees and unnoticeable to those who drive down Lower Campus Road. The Public Art Archive explained that the parallel bronze forms represent fascia or a bundle of reeds, which further emphasizes strength in numbers.' },
...
pathContent['stan_sheriff_center'] = {
    ...
    video_url: 		'',
    gallery_images: [
		{ image: 'S1.jpg', headline: 'Striving for superiority', description: "People are engaged in a constant quest for excellence, argues artist Shige Yamada. Through his twin sculptures, “Rainbows,” such striving for superiority becomes intertwined into an athletic context outside of UH Manoa’s Stan Sheriff Center." },
		{ image: 'S2.JPG', headline: 'Reaching for the sky', description: 'Unveiled in 1997, the work depicts two massive hands reaching toward the sky, one grasping a ball and one empty. The hands serve as a metaphor, speaking to the trials and tribulations of athletics, reflected in the fortunes of the UH men’s basketball team.' },
		{ image: 'S3.JPG', headline: 'Trying to inspire', description: 'Prior to the sculptures’ placement, in the shadow of the Stan Sheriff Center, the UH men’s basketball team only had made two NCAA tournament appearances in the program’s entire history.' },
		{ image: 'S4.JPG', headline: 'Maybe a good-luck charm?', description: 'Since then, however, the Rainbows have strove for excellence much better. The ‘Bows made NCAA tournament appearances in 2001, 2002 and 2016, advancing to the round of 32 in the latter.' },
		{ image: 'S5.JPG', headline: 'We are the champions', description: 'Within their Big West Conference, the Rainbows were tournament champions in those same years as well as regular-season champions in one other year, 2002. They also have been perennial contenders in the Big West, persisting in their quest for excellence.' },
    ],
    location: 		'',
...
pathContent['campus_center'] = {
    ...
    video_url: 		'',
    gallery_images: [
		{ image: 'C1.jpg', headline: 'Made in the ‘80s', description: "Hawai&#39;i Ka&#39;u Kumu, or “Hawai&#39;i is My Teacher,” was painted on the Campus Center walls at the University of Hawai&#39;i at Mānoa in 1982. Artist Calley O&#39;Neill says the mural, celebrating UH’s 70th anniversary, centers on how Hawai&#39;i’s people, food and energy flowed from mauka to makai." },
		{ image: 'C2.jpg', headline: 'A place for reflection', description: '<audio controls><source src="images/campus_center/Clip1.mp3" type="audio/mpeg"></audio><br />“I reflect and I meditate the time on the land and the people, nothing comes from ‘I want to do this.’ What is the community asking to communicate? … It’s a then and now. The left is the then and the right is the now,” O’Neill said.' },
		{ image: 'C3.png', headline: 'From plans to a painting', description: 'O’Neill spent two years researching and drawing sections of the mural.' },
		{ image: 'C4.jpg', headline: 'Savoring the moment', description: '<audio controls><source src="images/campus_center/Clip2.mp3" type="audio/mpeg"></audio><br />The mural features faces of real people around the islands with a story behind each person. O’Neill’s favorite element is the girls eating poi. “This is what life is about, savoring the moment, eating food of the land,” she said.' },
    ],
    location: 		'',
...
pathContent['loi'] = {
    ...
    gallery_images: [
		...
		{ image: 'L1.JPG', headline: 'Illustrating ancient cultivation systems', description: "Ka Papa Loʻi ʻO Kanewai, located next to the Hawaiʻinuiākea School of Hawaiian Knowledge, is an ancient Hawaiian parcel of land used to cultivate Kalo (Taro) using an integrated system of fresh water streams." },
		{ image: 'L2.JPG', headline: 'Rediscovered and reclaimed land', description: 'A group of Mānoa students rediscovered the abandoned ʻAwai (water ditch system) in 1980 and began planting Kalo and other indigenous and endemic plants. Through volunteers and UH Manoa students and staff regularly working the land, the art and tradition of Hawaiian agricultural practices continues.' },
		{ image: 'L3.JPG', headline: 'An outdoor classroom and teaching space', description: 'Today, Ka Papa Loʻi ʻO Kanewai consists of 10 terraces used to cultivate freshwater Kalo, classrooms and a Hale (covered thatched structure). The ancient loʻi is used as an outdoor classroom for many Manoa students and offers a place for those beyond the manoa campus to learn about the hawaiian perspective and way of thinking.' },
		{ image: 'L4.JPG', headline: 'Come and join the fun', description: 'Kanewai hosts a workday every first Saturday of the month, open to the public. It is recommended to bring: Slippers, T-shirt and shorts (that can get dirty), hat, sunglasses, sunscreen, water and water bottles, and snacks' },
    ],
    location: 		'',
    sharing: 		'Share your story',
...
pathContent['fallen_warrior'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'FW1.jpg', headline: 'Remembering students who defended us', description: 'Created by master carver Tuione Pulotu, The Fallen Warrior Memorial statue was erected in 2016, outside of the University of Hawaii at Manoa Army ROTC building. It was dedicated to the soldiers who graduated from that ROTC program and who died in wartime activities – in World War II, Vietnam, Iraq, or Afghanistan – giving the ultimate sacrifice for their country.' },
	{ image: 'FW2.jpg', headline: 'A combination of wood and rock', description: 'The statue is carved out of Monkey Pod wood. The base of the statue is built out of lava rock. Inside the base of the statue contains mementos from the fallen soldiers. ' },
	{ image: 'FW3.jpg', headline: 'An ongoing tribute', description: 'ROTC students and staff gather every morning to pay their respects to these soldiers. During their morning formation, the UH soldiers today place ceremonial weapons in the hands of the statue. The weapons symbolize the soldiers on a mission during the day. At the end of the day, the weapons are stored away to symbolize the end of the duty day.', }
    ],
...
pathContent['seien'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'S1.jpg', headline: 'An Ogata design', description: 'Ensconced behind Jefferson Hall is a stretch of lush grass, trickling waterfalls, and shady spaces. The East-West Center’s Seien or Peace Garden was a Japanese garden designed by leading landscape architect, Kenzo Ogata. It was a cooperative venture, financed by 22 Japanese business firms and involving specialists from Asia, the Pacific, and the United States.' },
	{ image: 'S2.jpg', headline: 'Receiving Akihito’s blessings', description: 'During a 1964 trip to Hawai’i, Emperor Akihito – then just Prince Akihito – blessed the garden with a traditional hold and release ceremony of a koi fish into the garden and planted a coral shower tree along the garden’s steps.' },
    ],
...
pathContent['peace'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'P1.jpg', headline: 'Commemoration of Japanese immigrants', description: 'Emerging from the lawn of the Kennedy Theatre is an imposing structure. Hewn from granite, the free-standing piece at first seems to defy physics, with the top half balancing, improbably, on a granite globe. In the shadow of the trees overhead, the Hawai’i Peace Memorial stands in commemoration of the first Japanese immigrants who came to work in Hawai’i’s plantation fields.' },
	{ image: 'P2.jpg', headline: 'Elements from a Buddhist perspective', description: '“It was by courage, sacrifice, and perseverance that they succeeded in establishing their roots deeply in the soil of their new land,” reads the tablet that dedicates the structure.<br/> The memorial mimics the Gorinto style, stone towers mainly seen at Buddhist temples and cemeteries. Each level of the piece is signified by an element of nature as indicated by the Japanese symbol carved onto the granite. They correspond to the five elements in the philosophy of Japanese Buddhism. Referred to as Godai, or the five great, these are commonly found in Buddhist architecture. Structures, like the Hawai’i Peace Memorial, are seen with five divisions to represent the five elements: creation, wind, fire, water, and earth.' },
    ],
...
pathContent['anuenue'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'A1.jpg', headline: 'How you say Rainbow in Hawaiian', description: 'Anuenue means “Rainbow” in Hawaiian, and this three-piece tapestry on Hamilton Library’s second floor is just that, with colors ranging from deep purple to bright yellow, contrasting against the industrial beige walls.' },
	{ image: 'A2.jpg', headline: 'Shape and movement in fibers', description: 'Woven into each panel is an arch that continues through each of the three panels, emulating the shape of a rainbow. Where two lines of beige wall show through, between the horizontal panels, a viewer might imagine the colors to be fluid and the carpet-like weaving to be waving. ' },
    ],
...
pathContent['backyard'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'B1.jpg', headline: 'A backyard cookout', description: 'Preparation for a luau is shown on this 1977 mural by Mataumu Toelupe Alisa, titled “Backyard Cooking.” People prepare an imu for a pig being brought. Poi also is being pounded, and laulaus are being wrapped.' },
	{ image: 'B2.jpg', headline: 'Passing down poi pounding', description: 'A family circles around the ku\'i ai (poi pounding board), as a child learns how to prepare this integral staple of family meals.' },
    ],
...
pathContent['bridge'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'B1.jpg', headline: 'Representing our local environment', description: 'Honolulu native Sidney Yee describes this painting to be a typical Saturday morning in our city’s Chinatown, and to be even more exact, on the corner of River and King streets. Not only does this picture depict the actual bridge, it symbolizes the fluid bridge between the present and the past.' },
	{ image: 'B2.jpg', headline: 'Symbols of the past overlaid on the present', description: 'Shadowy terra cotta soldiers fill the area under the bridge, representing our connection to the past.' },
    ],
    location: 		'Hamilton Library, 2nd floor',
    sharing: 		'Share your story',
...
pathContent['crack'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'C1.jpg', headline: 'The Great Manoa Crack Seed Caper', description: 'Jars filled with various assortments of salted, sweetened and dried nuts line the Ewa side of the second floor of the Physical Science Building. Once a vibrant array of colors, these nine jars have faded in the sun to a warm collection of browns and yellows.' },
	{ image: 'C2.jpg', headline: 'Looking over the merchandise', description: 'Maybe the best views of this mural are from the second story of the neighboring building, Bilger Hall. Names of the students responsible for painting this piece appear in the leftmost jar.' },
    ],
...
pathContent['chinese'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'C1.jpg', headline: 'A terracotta sentry', description: 'More than 8,000 terracotta warriors and horses have been found in the Mausoleum of the First Qin Emperor. This replica appears modeled after an infantry, calvary or chariot warrior, meant for the purpose of protecting the Emperor. Standing nearly 6 feet tall, these warriors can weigh up to 700 pounds. The duel-layer gown this replica is wearing shows that this is a higher ranking soldier. Knots and laces adorning the smooth leather suggest that this may have been a Qin general. ' },
	{ image: 'C2.jpg', headline: 'Connection to the Qin Mausoleum', description: 'This particular replica was given to the university by Nobumoto Tanahashi in 1987, the same year the Mausoleum became listed as a World Heritage Site. Tanahashi was a Japanese businessman, whose personal mission was world peace.' },
    ],
...
pathContent['commencement'] = {
	...
	{ image: 'C1.jpg', headline: 'A wall-length fresco', description: 'Once a vibrant fresco depicting a commencement ceremony, this painting reaches down the long hallway of Bachman Hall.' },
	{ image: 'C2.jpg', headline: 'Another work by Charlot', description: 'Details of a college graduation are painted by artist Jean Charlot. Born in France at the turn of the 20th century, Charlot came to the University of Hawaii in 1949 and became a professor.' },
    ],
    location: 		'Hamilton Library, 4th floor',
    sharing: 		'Share your story',
...
pathContent['defining'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'D1.jpg', headline: 'Mapping the destruction', description: 'Inspired by post-flood reconstruction of the libraries’ map collection, artist Ross Togashi used mixed media to represent the view from his mind’s eye. The year following the library’s devastating flood in 2004, which filled the basement with water, former map keeper Togashi said he wanted to make something that represented his feelings regarding the destruction and rebuilding.' },
	{ image: 'D2.jpg', headline: 'Inspired by a flood', description: 'Chaos and disorder are a few of the feelings you get from seeing a scaled-down representation using a variety of materials. A chair thrown through a window. Stains shining through.' },
    ],
...
pathContent['flight'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'F1.jpg', headline: 'Mapping the destruction', description: 'Inspired by post-flood reconstruction of the libraries’ map collection, artist Ross Togashi used mixed media to represent the view from his mind’s eye. The year following the library’s devastating flood in 2004, which filled the basement with water, former map keeper Togashi said he wanted to make something that represented his feelings regarding the destruction and rebuilding.' },
	{ image: 'F2.jpg', headline: 'Inspired by a flood', description: 'Chaos and disorder are a few of the feelings you get from seeing a scaled-down representation using a variety of materials. A chair thrown through a window. Stains shining through.' },
    ],
    location: 		'Hamilton Library, 2nd floor',
    sharing: 		'Share your story',
...
pathContent['nana'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'N1.jpg', headline: 'Where does it come from?', description: 'Three panels of cloth, covering redwood, depict people in traditional Hawaiian clothing illustrating their cultural roots. “Nana I Ke Kumu” translates to “Look to the Source.”' },
	{ image: 'N2.jpg', headline: 'Education comes from somewhere', description: 'Cultural specialist Charles Kauluwehi Maxwell, Sr., wrote that ancient Hawaiians used this phrase to describe the practice of “educating the youth to seek answers from the elderly people around them.”' },
    ],
...
pathContent['rain'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'R1.jpg', headline: 'Subtle color, meanings', description: 'A wispful white and blue acrylic painting that looks similar to watercolor paintings that artist and former UH Manoa Art Department chairman John Wisnosky created during this period of his life. ' },
	{ image: 'R2.jpg', headline: 'White on white, with a bit of blue', description: 'Very light clouds of blue touch on a white background. Against a white wall, this can be easy to miss.' },
    ],
    location: 		'Hamilton Library, 2nd floor',
    sharing: 		'Share your story',
...
pathContent['pigeon'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'P1.jpg', headline: 'A traditional batik style', description: 'Yellows, pinks and blues highlight a beige and brown background on cloth. When looking close, small white dots make up the mass of design on this cloth.' },
	{ image: 'P2.jpg', headline: 'A complicated cloth-dying process', description: 'Wax was drawn on this cloth in the shape of “pigeon eyes,” and the cloth was dyed around it. The title of this painting, in turn, is “The Pigeon.”' },
    ],
    location: 		'Hamilton Library, 2nd floor',
    sharing: 		'Share your story',
...
pathContent['untitled2'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'U1.jpg', headline: 'A focus on technique', description: 'An abstract acrylic painting filled with whites and blues highlights the different patterns and brush strokes artists can make with acrylic paints.' },
	{ image: 'U2.jpg', headline: 'Another work by UH’s Wisnosky', description: 'White hairlike-whisps fall down over a foggy-blue background in former Art Department Chairman John Wisnosky’s Untitled painting from 1984.' },
    ],
    location: 		'Hamilton Library, 2nd floor',
    sharing: 		'Share your story',
...
pathContent['untitled3'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'U1.jpg', headline: 'Ceramic on concrete', description: 'Ceramicist Isami Enomoto designed this abstract ceramic mural to adorn the concrete walls of Kuykendall Hall.' },
	{ image: 'U2.jpg', headline: 'A silverish look', description: 'Thick brush strokes of deep brown, beige, white and blues cover this viney piece and, from a far distance, may appear to be silver.' },
    ],
...
pathContent['wa'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'W1.jpg', headline: 'Looking for Harmony? Here it is', description: 'This 1982 clay sculpture is named “Wa,” which translates from Japanese into English as harmony. This word gives the meaning of unity within a group.' },
	{ image: 'W2.jpg', headline: 'Made by a KCC lecturer', description: 'Wayne Miyata worked as a lecturer at Kauai Community College.' },
    ],
...
pathContent['water_garden'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'W1.jpg', headline: 'Built and rebuilt', description: 'Originally created in 1948 by Richard Tongg and Lorraine Kuck, this water garden is an example of early 20th century landscape design. It was restored by Betsy Sakata in 1996. She is an expert in water lilies.' },
	{ image: 'W2.jpg', headline: 'Tongg designs elsewhere', description: 'The Asian gardens at Honolulu International Airport also were were designed by Richard Tongg.' },
    ],
...
pathContent['pair'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'P1.jpg', headline: 'Added, upon request', description: 'The pair of Fu Dogs outside of Jefferson Hall at the East-West Center were a gift from Taiwan in 1971, at the request of UH students from that region of the world.' },
	{ image: 'P2.jpg', headline: 'A male and a female', description: 'Consisting of one male (makai side) and one female (mauka side), both lion-dogs sit with their heads turned toward one another, their hands on a round ball. ' },
    ],
    location: 		'Outside Krauss Hall',
    sharing: 		'Share your story',
...
pathContent['hamilton_lib'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'H1.jpg', headline: 'In a churn of water', description: 'On loan from the Hawaii State Foundation on Culture and the Arts, "Swimmer\'s Quilt" is about losing one\'s identity in a pool full of swimmers, a recurring theme in Mari Sakamoto\'s artworks. "In the annual Waikiki Roughwater Swim all wear the same caps, splash water in the same manner, and make a very beautiful pattern,” Sakamoto told the Hawaii State Art Museum.' },
	{ image: 'H2.jpg', headline: 'Same theme, different medium', description: 'In comparison to Sakamoto’s paintings, “Swimmer’s Quilt” presents the group identity of a crowd in pattern stitching, a medium that conveys the idea in “a warm and comforting way.”' },
    ],
    location: 		'Hamilton Library, CILC Lab',
    sharing: 		'Share your story',
...
pathContent['wallhanging'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'W1.jpg', headline: 'Pheasant feathers and chenille', description: 'Jean Williams’ Wallhanging is a three dimensional woven piece made with pheasant feathers and chenille, a velvety yarn, spun and dyed by the artist. Williams originally taught herself weaving and and fiber arts. She later studied at the University of Hawaii at Manoa, where she also worked as a lecturer. Williams’ art incorporates both synthetic and natural fibers, including yarns she spins herself, which help give structure to her multidimensional pieces.' },
	{ image: 'W2.jpg', headline: 'Using local materials', description: 'Williams also experiments with using local plant and vegetable dyes, as well as organic materials found in the environment, according to the Public Art Archive. Wallhanging is on loan from the Hawaii State Foundation on Culture and the Arts.' },
    ],
    location: 		'Hamilton Library, microfilm room',
    sharing: 		'Share your story',
...
pathContent['nth'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'N1.jpg', headline: 'The interconnectedness of currency', description: '“To the Nth Power” was created in 1971 by Charles W. Watson. The sculpture has five reddish-brown circles intertwining, which represent money.' },
	{ image: 'N2.jpg', headline: 'From Canada to Oahu', description: 'Watson was born in Guelph, Ontario, Canada, but died in Kaneohe, Hawaii. Besides at UH, the Honolulu Museum of Art’s Spalding House also features Watson’s work.' },
    ],
    location: 		'In front of Shidler Hall',
    sharing: 		'Share your story',
    thumbnail: 		'images/nth/thumbnail.jpg',
    centerpiece: 	'images/nth/thumbnail.jpg',
    geo_location: 	'21.3001153,-157.819923', 
    lat: 			21.3001153,
    lon: 		    -157.819923
};
...
pathContent['sumotori'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'N1.jpg', headline: 'The size of a sumo', description: 'Created by Greg Culman in 1975, this stone white-ish statue conveys the size of a sumo wrestler. It is a rock sculpture that shows a wrestler crossing his arms, but it does not have a lower body. The artwork has some discoloration and cracks. ' },
	{ image: 'N2.jpg', headline: 'History and tradition', description: 'The sculpture is said to be a mixture of the history of a sumo wrestler intertwined with traditions that many sumo wrestlers still practice to this day.' },
    ],
    location: 		'In front of Orvis Auditorium',
    sharing: 		'Share your story',
...
pathContent['buddha'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'B1.jpg', headline: 'Made in the 15th century', description: 'The date of this work and who made it are unknown, but it appears to be from the 15th century, making it one of the oldest artworks at UH.' },
	{ image: 'B2.jpg', headline: 'How did it get to Hawaii?', description: 'This is a wood and lacquer sculpture. This buddha appears to be in meditation. How it came to Hawaii and what it has seen throughout the centuries is a mystery.' },
    ],
    location: 		'Hamilton Library, 4th floor',
    sharing: 		'Share your story',
...
pathContent['rosarito'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'R1.jpg', headline: 'From ethereal to people', description: 'Wisnosky was a painter and also the former chairman of the art department at the University of Hawaii at Manoa. He is best known for his use of acrylic and watercolor. His early works showcased “ethereal clouds and valleys achieved with delicate air-brush technique.” This 1995 work, though is quite different.' },
	{ image: 'R2.jpg', headline: 'Donated by the Wisnosky family', description: 'It was a gift to the library from Wisnosky’s wife, Merium, in 2012.' },
    ],
...
pathContent['rainbow_spirit'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'R1.jpg', headline: 'Neon and copper', description: '“Rainbow Spirit” is intended to instill some sort of mystery, magic, and excitement in the air around a big game.' },
	{ image: 'R2.jpg', headline: 'Togetherness as a symbol', description: 'It was created by Barbara Miyano-Young in 1998 and is part of the Hawaii State Foundation on Culture and the Arts. She stated she wanted to mirror the togetherness of athletics.' },
    ],
...
pathContent['shinto_dogs'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'S1.jpg', headline: 'Guardians of the library', description: 'Known as “Animal Guardian Figures,” these “lion-dog” figures were brought from Japan in 1924 to be placed at the Shinto Wakamiya Inari Shrine, which was on King Street.' },
	{ image: 'S2.jpg', headline: 'At UH since World War II', description: 'These dogs were moved to UH Manoa in 1942.' },
    ],
...
pathContent['neumes'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'N1.jpg', headline: 'A representation of breath', description: '“Neume” means breath, and that is a basic element for both the Western and Eastern musical notations.' },
	{ image: 'N2.jpg', headline: 'In a state of disrepair', description: '“Neumes o Hawaii” was created in 1976 by Suzi Pleyte Horan. As a ceramic tile bench, it is both colorful and fades into the landscape. If you look closely, though, hieroglyphics are engraved on the tiles and some of them are damaged or missing.' },
    ],
    location: 		'In front of Orvis Auditorium',
    sharing: 		'Share your story',
...
pathContent['mind'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'M1.jpg', headline: 'A burning symbol', description: '“Mind and Heart” was created by LInda Yamamoto in 1995. The sculpture is made of bronze and resembles a twisting flame.' },
	{ image: 'M2.jpg', headline: 'A current UH teacher', description: 'Yamamoto created the sculpture after President Franklin D. Roosevelt’s announcement that Japanese Americans would be allowed to serve in the American military, adding such service was “a matter of the mind and heart, not a matter of race or ancestry.” Yamamoto teaches at UH Manoa.' },
    ],
    location: 		'QLC, ground floor',
    sharing: 		'Share your story',
...
pathContent['mana'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'M1.jpg', headline: 'Confidence and faith', description: '“Mana’o’io” means “confidence and faith.” This statue was created by a Kauai native, Bumpei Akaji. Akaji was born in 1921 in Lawai, Kauai. Bumpei served in the famed 442 Battalion in World War II, composed mostly of second-generation soldiers of Japanese ancestry, and after his discharge, he went to Milan to study the arts.' },
	{ image: 'M2.jpg', headline: 'A symbol of unity, strength, and purity', description: 'In 1981, Akaji created this sculpture out of metal (bronze and copper). The art is intended to be symbolic of unity, strength, and purity.' },
    ],
...
pathContent['hula'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'H1.jpg', headline: 'A hidden gem', description: 'Hula was created by Mataumu Alisa in 1982. It is located on the second floor of the Physical Education Athletic Complex Multi-Purpose Lecture Building, near Room 241.' },
	{ image: 'H2.jpg', headline: 'Sharing hula traditions', description: 'The art portrays men and women dancing the traditional hula using the traditional instruments. The art is considered to be one of the Art in Public Places pieces.' },
    ],
...
pathContent['hina'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'H1.jpg', headline: 'Mother of the Universe', description: 'Hina-o Nalani (or Mother of the Universe) was created by Gregory Clurman in 1975. Clurman used a block of Minnesota granite that had a pinkish tinge of Rosa Porrino, which is another way to say it is pink granite.', caption: 'Courtesy of UH Archives' },
	{ image: 'H2.jpg', headline: 'In a new place', description: 'Originally, it was in the middle of a Campus Center pathway, but it later was moved.' },
    ],
...
pathContent['epitaph'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'E1.jpg', headline: 'A horror, or a warning', description: 'At the entrance to Hamilton Library, this Harold Tovish piece is a cross of sorts and, if you look closely, contains a face.' },
	{ image: 'E2.jpg', headline: 'Modern-day issues', description: 'Tovish, who created this piece in 1970, modeled the sculpture so it “belongs on the cover of a Clive Barker horror novel.” He said it reflects the dilemmas and issues that modern-day humans face. ' },
    ],
...
pathContent['chance'] = {
    ...
    video_url: 		'',
    gallery_images: [
	{ image: 'C1.jpg', headline: 'Odd people, oddly dressed', description: 'These statues are standing under a crosswalk sign that gives direction to different locations on the island. The design originally was from New York, hence the raincoats, and they are engaged in a conversation.' },
	{ image: 'C2.jpg', headline: 'Taken out of place but given place', description: 'This artwork was created by George Segal in 1992, and it is part of the Art in Public Places Program.' },
    ],
